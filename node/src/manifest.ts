...
export const DEFAULT_MANIFEST = {
  ...
  name: "MonadForge Node",
  version: "1.0.0",
  description:
    "Autonomous Node Hub-compatible Execution Node for the Monad Blockchain",
  skills: [
    "generate_contract",
    "run_audit",
    "deploy_contract",
...
export const SKILL_PACKAGES: Record<string, any> = {
    ...
    schema: {
      ...
      inputs: {
        ...
        properties: {
          ...
          domain: {
            type: "string",
            enum: ["erc20", "erc721", "staking", "marketplace", "dao", "amm"],
          },
        },
  ...
  run_audit: {
    ...
    schema: {
      ...
      version: "1.0.0",
      description:
        "Performs AST and rule-based security audits on Solidity contracts",
      inputs: {
        type: "object",
        properties: {
          code: { type: "string" },
  ...
  deploy_contract: {
    ...
    schema: {
      ...
      version: "1.0.0",
      description:
        "Compiles, deploys, and verifies Solidity contracts on Monad networks",
      inputs: {
        type: "object",
        properties: {
          filePath: { type: "string" },
  ...
  verify_contract: {
    ...
    schema: {
      ...
      version: "1.0.0",
      description:
        "Verifies deployed smart contracts on Monad Sourcify/block explorer",
      inputs: {
        type: "object",
        properties: {
          contractAddress: { type: "string" },
  ...
  search_docs: {
    ...
    schema: {
      ...
      version: "1.0.0",
      description:
        "Queries the local knowledge base for Monad development guidelines",
      inputs: {
        type: "object",
        properties: {
          query: { type: "string" },
  ...
  execute_action: {
    ...
    schema: {
      ...
      version: "1.0.0",
      description:
        "Executes an action (mint, transfer, swap, stake) on a deployed Monad contract",
      inputs: {
        type: "object",
        properties: {
          action: {
            type: "string",
            enum: ["mint", "transfer", "swap", "stake"],
          },
          contractAddress: { type: "string" },
          to: { type: "string" },
          amount: { type: "string" },
...
export class NodeIdentity {
  ...
  public static getSkillPackages(): any[] {
    return Object.values(SKILL_PACKAGES).map((pkg) =>
      SkillPackageSchema.parse(pkg),
    );
  }
