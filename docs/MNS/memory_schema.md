# Monad Node Standard (MNS): Memory Schema

Version: `1.0.0`

## Specification

The Memory Schema outlines the project metadata stored locally to preserve historical context across node restarts.
