# Monad Agent Standard (MAS) Specification

Version: 1.0.0  
Status: Proposal  

The Monad Agent Standard (MAS) defines schemas, protocols, and interfaces for interoperability between autonomous AI agents operating within the Monad blockchain ecosystem.

---

## 1. Skill Schema

A Skill defines a reusable, atomic capability that an agent can route tasks to.
